...
export const article = {
  ...
  description:
    "An attempt to add to an already-started conversation.",
    published: true,
}
...
Alas, the Alex DeLarge that is American society preferred them dead compared to looking a reflection of itself.
