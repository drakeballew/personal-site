...
Like any model, what I am about to suggest is rife with faults and incomplete in explanatory power. **But consider the following: the most important “controllable” is not actually an input to Maddon’s machine, it is what we come to believe about the inputs when we see what comes out.**
